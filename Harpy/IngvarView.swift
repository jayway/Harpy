            ...
            UIView.animate(withDuration: bubbleDuration, delay: 0, options: [.curveEaseInOut], animations: {
                ...
                UIView.animate(withDuration: bubbleDuration, delay: 0, options: [.curveEaseInOut], animations: {
                    ...
                    UIView.animate(withDuration: bubbleDuration, delay: 0, options: [.curveEaseInOut], animations: {
                        ...
                        UIView.animate(withDuration: ingvarRemoveDuration, delay: 0, options: [.curveEaseInOut], animations: {
                        ...
                        UIView.animate(withDuration: removeDuration, delay: 0, options: [.curveEaseInOut], animations: {
                            self.alpha = 0
